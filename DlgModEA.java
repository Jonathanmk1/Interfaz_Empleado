...
public class DlgModEA extends javax.swing.JDialog {

    public DlgModEA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        switch (opc) {
            case "1": {
                ...
                if (po != -1) {
                    ...
                    ((EmpleadoAsalariado) cPP.get(po)).setNombre(nom);
                    Archivo.guardar(cPP, "cPPEA.dat");
            ...
            case "2": {
                ...
                if (po != -1) {
                    ...
                    ((EmpleadoAsalariado) cPP.get(po)).setApellido(Ape);
                    Archivo.guardar(cPP, "cPPEA.dat");
            ...
            case "3": {
                ...
                if (po != -1) {
                    sal = Integer.parseInt(JOptionPane.showInputDialog(this, "Ingresa el salario: "));
                    ((EmpleadoAsalariado) cPP.get(po)).setSalario(sal);
                    Archivo.guardar(cPP, "cPPEA.dat");

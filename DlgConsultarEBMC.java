 ...
 * @author USER
 */
public class DlgConsultarEBMC extends javax.swing.JDialog {

    /**
     * Creates new form DlgConsultarEPH
     */
    public DlgConsultarEBMC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnconsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconsuActionPerformed
        ...
        if (po != -1) {
            JOptionPane.showMessageDialog(this, ((EmpleadoBasemComision) cPP.get(po)).toString());
        } else {

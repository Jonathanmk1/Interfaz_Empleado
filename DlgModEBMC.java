...
public class DlgModEBMC extends javax.swing.JDialog {

    public DlgModEBMC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        switch (opc) {
            case "1": {
                ...
                if (po != -1) {
                    ...
                    ((EmpleadoBasemComision) cPP.get(po)).setNombre(nom);
            ...
            case "2": {
                ...
                if (po != -1) {
                    ...
                    ((EmpleadoBasemComision) cPP.get(po)).setApellido(Ape);
                    Archivo.guardar(cPP, "cPPEBMC.dat");
            ...
            case "3": {
                ...
                if (po != -1) {
                    ...
                    ((EmpleadoBasemComision)cPP.get(po)).setVentastotal(vt);
                    Archivo.guardar(cPP, "cPPEBMC.dat");
            ...
            case "4":{
                ...
                if (po != -1) {
                    ...
                    ((EmpleadoBasemComision)cPP.get(po)).setTarifasporcomision(tc);
                    Archivo.guardar(cPP, "cPPEBMC.dat");
            ...
            case "5":{
                ...
                if (po != -1) {
                    sal = Integer.parseInt(JOptionPane.showInputDialog(this, "Dame El nuevo salario: "));
                    ((EmpleadoBasemComision)cPP.get(po)).setSalariobase(sal);
                    Archivo.guardar(cPP, "cPPEBMC.dat");
                    JOptionPane.showMessageDialog(this, "EL salario de= " + id + "se modifico satisfactoriamente");
                } else {
                    JOptionPane.showMessageDialog(this, "El id: " + id + "no existe");
                }

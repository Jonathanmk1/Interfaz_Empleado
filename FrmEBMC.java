...
public class FrmEBMC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENU: EMPLEADO POR COMISION");
    ...
    private void txtOpcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtOpcActionPerformed
        ...
        switch (opc) {
            case "1":
                DlgAltasEBMC v;
                v = new DlgAltasEBMC (this, true);
                v.setVisible(true);
                break;
            case "2":
               DlgBajasEBMC  b = new  DlgBajasEBMC (this, true);
               b.setVisible(true);
                break;
            case "3":
               DlgConsultarEBMC  c = new DlgConsultarEBMC (this, true);
               c.setVisible(true);
                break;
            case "4":
                DlgModEBMC  mo = new DlgModEBMC (this, true);
                mo.setVisible(true);
                break;
            case "5":
                 DlgReportesEBMC  r;
                r = new DlgReportesEBMC (this, true);
                r.setVisible(true);
                break;
            case "6":

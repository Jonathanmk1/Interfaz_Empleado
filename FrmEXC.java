...
public class FrmEXC extends javax.swing.JFrame {
    ...
    private void txtOpcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtOpcActionPerformed
        ...
        switch (opc) {
            case "1":
                DlgAltasEXC v;
                v = new DlgAltasEXC(this, true);
                v.setVisible(true);
                break;
            case "2":
               DlgBajasEXC b = new  DlgBajasEXC(this, true);
               b.setVisible(true);
                break;
            case "3":
               DlgConsultarEXC c = new DlgConsultarEXC(this, true);
               c.setVisible(true);
                break;
            case "4":
                DlgModEXC mo = new DlgModEXC(this, true);
                mo.setVisible(true);
                break;
            case "5":
                 DlgReportesEXC r;
                r = new DlgReportesEXC(this, true);
                r.setVisible(true);
                break;
            case "6":
